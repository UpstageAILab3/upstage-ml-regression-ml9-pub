...
- 조용중
    - 좋은 팀원들과 재미있게 프로젝트 했습니다

- 김나리
    - 전처리의 중요성은 아무리 해도 지나치지 않습니다. 필요하다고 생각하는 피쳐의 전처리는 끝까지 해보는 것이 중요하다고 느꼈습니다.
    - 개인적으로는 조원들을 통하여 체제적인 모델링 진행과정을 많이 배웠습니다.
...
- 한지웅
    - 지난 번 캐글 ML 대회에 이어서 이번 대회에 참여하며, 머신러닝 분야의 경우 '데이터'의 중요성이 매우 크다는 것을 몸소 느낄 수 있었습니다.
    - 이번에 얻게 된 인사이트를 이후의 딥러닝 대회 등에서도 적용하며 더욱 성장하고 싶습니다.
